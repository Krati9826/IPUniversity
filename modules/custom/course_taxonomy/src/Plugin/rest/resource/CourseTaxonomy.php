...
namespace Drupal\course_taxonomy\Plugin\rest\resource;
 ...
 * @RestResource(
 *   id = "course_taxonomy",
 *   label = @Translation("Course taxonomy"),
 *   uri_paths = {
 *     "canonical" = "/course-taxonomy"
 *   }
 * )
 */
class CourseTaxonomy extends ResourceBase {
  /**
